...
def test_cache():
    ...
    img1 = DecodedImage(buffer=memoryview(np.zeros(60, dtype=np.uint8)), width=60, height=1, bytes_per_line=60, format="dummy_format")
    img2 = DecodedImage(buffer=memoryview(np.zeros(60, dtype=np.uint8)), width=60, height=1, bytes_per_line=60, format="dummy_format")
